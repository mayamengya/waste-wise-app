...
def image_detection(file_name):
    ...
    with open(make_unique_json_file('json_outputs', 'output.json'), 'w') as results_write_json:
...
"""
print(image_detection('tests/trash_image_38.jpg'))
print(image_detection('tests/trash_image_39.jpg'))
print(image_detection('tests/trash_image_40.jpg'))
